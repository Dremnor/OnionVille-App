...
$requests = $DB->getAllUserRequests($user['id']);
?>
                        ...
                        <?php if ($status['id'] != 7) : ?>
                            <div class="card text-center color3-bg mt-4 mx-2 card-border" style="width: 19rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <div>
                                        <?php
                                        if ($status['id'] == 3 || $status['id'] == 5 || $status['id'] == 6) {
                                            echo printRequestButtons($request['status_id'], '/php/userrequest.php', 3, $request['id']);
                                        }
                                        ?>
                                    </div>
                                </div>
